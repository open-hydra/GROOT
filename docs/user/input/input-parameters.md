...
| optically_thin | `.false.` | `.true.`, `.false.` | no | Optically-thin approximation for the source term (skips absorption along rays) |

## [GROOT-Model]

| Parameter | Default | Allowed | Required | Description |
|-----------|---------|---------|----------|-------------|
| model | `const` | `const`, `gray`, `wsgg`, `wsgg-H2O`, `wsgg-H2OCO2` | no | Spectral model for the gas-phase absorption coefficient |
