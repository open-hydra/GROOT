...
Thank you for your interest in contributing to GROOT.  This page
...
| **Module naming** | `GROOT_<Name>` for public modules |
...
- File name matches module name minus the `GROOT_` prefix
  (e.g. `Lib_RTE.f90` → module `GROOT_Lib_RTE`).
...
```
Add WSGG Fabiani 2025

Implement the high temperature/pressure of Fabiani (Journal of Proulsion and Power 2025) for H2O/CO2 mixtures.
