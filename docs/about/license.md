...
GROOT is free and open-source software licensed under the GNU General Public License v3.0 (GPL-3.0).

## Quick Summary

!!! info "License at a Glance"
    - ✅ **Use** - Use GROOT for any purpose
    - ✅ **Modify** - Change the source code as needed
    - ✅ **Distribute** - Share GROOT with others
...
- **Download and use** GROOT without restrictions
- **Use GROOT in research**, including published work
- **Use GROOT commercially** in your business or organization
- **Modify GROOT** to suit your needs

### As a Distributor

If you distribute GROOT (modified or unmodified):
...
By contributing to GROOT:

- You grant GROOT permission to use your contributions
...
GROOT (GPL-3.0) is compatible with:
...
!!! warning "License Compatibility"
    When combining GROOT with other software, ensure all licenses are compatible.

## Dependencies and Their Licenses

GROOT uses several dependencies, each with its own license:
...
- **In the repository:** [LICENSE](https://github.com/open-hydra/GROOT/blob/main/LICENSE) file
- **Online:** [gnu.org/licenses/gpl-3.0.html](https://www.gnu.org/licenses/gpl-3.0.html)

## Warranty Disclaimer

!!! warning "No Warranty"
    GROOT is provided "as is" without warranty of any kind, either expressed or implied. See the full license for complete warranty disclaimer.
